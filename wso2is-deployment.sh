...
data:
  deployment.toml: |-
    ...
    type = "postgres"
    url = "jdbc:postgresql://wso2is-rdbms-service-postgres:5432/wso2is_identity_db"
    username = "wso2carbon"
    password = "wso2carbon"
    ...
    [database.shared_db]
    type = "postgres"
    url = "jdbc:postgresql://wso2is-rdbms-service-postgres:5432/wso2is_shared_db"
    username = "wso2carbon"
    password = "wso2carbon"
    driver = "org.postgresql.Driver"
...
data:
  init.sql: |-
      ...
      grant all privileges on database wso2is_shared_db to wso2carbon;
      grant all privileges on database wso2is_identity_db to wso2carbon;
...
function deploy(){
    ...
    sed -i.bak 's|"$image.pull.@.aaujayasena"|'$IMG_DEST'|g' $k8s_obj_file
